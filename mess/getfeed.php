...
<table align="center" width="900"  border="1" bordercolor="silver">
    	<tr>
        	<td colspan="30" align="center" bgcolor="white"><h1>Feedbacks</h1>
        ...
        <tr align="center">
        	...
        	<th><font color="gold">ID</th>
        	<th><font color="gold">NAME</th>
        	<th><font color="gold">EMAIL</th>
        	<th><font color="gold">SUBJECT</th>
        	<th><font color="gold">DESCRIPTION</th>
            </tr>

<?php
$que = "select * from feedback order by 1 DESC";
		...
		?>	
         <tr align="center"> 
			...
			<td style="color:#FFF"><?php echo $ab4; ?></td>
			 
       </tr>
		<?php } ?>
        </table>
        <!-- Footer -->
    	<br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><footer id="footer">
