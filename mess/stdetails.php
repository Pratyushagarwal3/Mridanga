...
<table align="center" width="900" border="" bordercolor="silver">
    	<tr>
        	<td colspan="30" align="center" bgcolor="white"><h1>CONSOLIDATED DUES LIST</h1>
        ...
        <tr align="center">
        	...
        	<th><font color="gold">Inmate's ID</th>
        	<th><font color="gold">Inmate's First Name</th>
        	<th><font color="gold">Inmate's Last Name</th>
        	<th><font color="gold">Dues</th>
            </tr>

<?php
$que = "select * from inmate order by 1 DESC";
